...
# This function transforms a point P from the pareto frontier into a constellation 
function p2c(P, nsat::Number; nvars::Number = 4)
...
function start_data(numsat::Number)
    ...
    ### List of Data Collection Stations - PCD
    ...
    ### variables design restriction
    a = (max = 8380, min = 6880);       # [km]  semi-major axis;
    #e = (max = 0.01, min = 0.0);       # [-]   eccentricity;
    i = (max = deg2rad(100), min = 0);  # [deg] orbit inclination;
    ...
    #= número de bits
    a = 8;      # resolução 10km para 8380-6880 km
    e = 0;      # constante = 0
    i = 7;      # resolução 1° 
    Ω = 8;      # resolução de 2°
    ω = 0;      # constante = 0      
